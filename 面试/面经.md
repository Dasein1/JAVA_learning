...
# 4.28 招商
## 第一题
![](images/2022-04-29-00-09-20.png)
![](images/2022-04-29-00-09-29.png)
```java
class Solution{
    public int sort(int N,int[] origin,int[] target){
...
public class Solution {
    public static void main(String[] args) {
        ...
        System.out.println(result(Left,N,origin,target));


    }

    public static int result(int Left, int N, int[] origin, int[] target) {
        int results = 0;
...
## 第二题
![](images/2022-04-29-00-08-01.png)
![](images/2022-04-29-00-07-42.png)
```java
...
public class Main {
    public static void main(String[] args) {
        ...
        solution.walk(n,target,order,0);
...
class Solution3{
    ...
    int[] result;
    int[] cur=new int[]{0,0};
    public void walk(int n,int[] target,int[][] order,int start){
        if(cur[0]==target[0] && cur[1]==target[1]){
            result[walk_nums-1]+=1;
            return;
        }
        if(start>=n){
            return;
...
## 第三题
![](images/2022-04-29-00-08-39.png)
![](images/2022-04-29-00-08-53.png)
