...
[Java属性的继承](https://blog.csdn.net/Luck_ZZ/article/details/95231037)
[Java中private方法能重写吗？](http://t.zoukankan.com/daichangya-p-12958746.html)
...
public class test {
    public static void main(String[] args) {
        ...
        son.print();    // 输出“我是儿子”
        Father father=son;
        father.dd();    // 输出“我是儿子”，若Father类中的print（）方法的访问修饰符为private，那么输出为“我是父亲”
    }
}
